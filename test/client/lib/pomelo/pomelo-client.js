...
const decodeIO_decoder = protobufjs.Root.fromJSON(require("/Users/inter/Code/go-connector/test_proto/target.json"));
const decodeIO_encoder = null;//= protobufjs.Root.fromJSON(clientProto);
const push_decoder = protobufjs.Root.fromJSON(require("/Users/inter/Code/go-connector/test_proto/target.json"));//= protobufjs.Root.fromJSON(pushProto);
